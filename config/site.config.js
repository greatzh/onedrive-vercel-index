...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'zhzhang@zihol.onmicrosoft.com',
  ...
  protectedRoutes: ['/Private Share', '/Private Tmp'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:iamzhzhang@gmail.com',
